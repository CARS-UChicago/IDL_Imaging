pro find_2d_peaks, image, x, y, flux, sharp, roundness, hmin, fwhm, $
                      roundlim, sharplim,$
...
;
; CALLING SEQUENCE:
;	FIND_2K_PEAKS, image, [ x, y, flux, sharp, round, hmin, fwhm, 
;               roundlim, sharplim, PRINT= , /SILENT ]
;
; INPUTS:
...
;
; OPTIONAL INPUTS:
;	FIND_2D_PEAKS will prompt for these parameters if not supplied
;
...
;       Renamed from FIND to FIND_2D_PEAKS to avoid name collisions 
;                       M. Rivers Oct. 1998
;-
;
